                ...
                <div class="col-md-6">
                    ...
                    <form action="{{ route('update', ['id' => $product->id]) }}" method="POST"/>
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" name="made_in" class="form-control col-sm-10" value="{{ $product->made_in }}">
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2">stock</label>
                            <input type="number" name="stock" class="form-control col-sm-10" value="{{ $product->stock }}">
                        </div>
